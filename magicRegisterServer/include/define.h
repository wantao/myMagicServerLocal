...
//用户最大好友个数
#define USER_MAX_FRIEND_COUNT 30
...
//从好友表中取出的助战基友个数
#define FRIEND_HELP_FRIEND_COUNT	5
...
//卡牌升级所需经验
#define CARD_LEVEL_UP_NEED_EXP(u_level)	(u_cardLevel + 1)*(u_cardLevel + 1)*(u_cardLevel + 1)*10
